...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 209.478723526000977, 149.5, 80.0, 22.0 ],
					"text" : "loadmess 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 331.0, 145.0, 74.0 ],
					"range" : [ -1.1, 1.1 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 218.0, 380.0, 97.0, 25.0 ],
					"text" : "output value",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 185.0, 225.5, 101.0, 25.0 ],
					"text" : "bias"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.0, 187.5, 101.0, 25.0 ],
					"text" : "weight"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 122.0, 227.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 77.5, 189.0, 56.0, 22.0 ],
					"sig" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 33.0, 151.0, 53.0, 22.0 ],
					"text" : "rand~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 95.0, 149.5, 101.0, 25.0 ],
					"text" : "input values"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.0, 331.0, 97.0, 25.0 ],
					"text" : "binary result"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 33.0, 269.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Signal rate implementation of a perceptron, an artificial neuron returning 1 if input*weight + bias > 0, and 0 otherwise.",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 87.0, 213.0, 87.0, 213.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 2 ],
					"midpoints" : [ 131.5, 252.0, 131.5, 252.0 ],
					"source" : [ "obj-9", 0 ]
				}
